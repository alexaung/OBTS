...
import com.myanmar.obts.util.CalendarDecorator;
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        calendar.setOnDateSelectedListener(new CalendarPickerView.OnDateSelectedListener() {
            ...
            public void onDateSelected(Date date) {
                ...
                Toast.makeText(getApplication(), DateFormat.format("dd/MMM/yyyy", date), Toast.LENGTH_SHORT).show();
                ticketPackage.setRouteDate(DateFormat.format("dd-MM-yyyy", date).toString());
                Bundle b=new Bundle();
            ...
            public void onDateUnselected(Date date) {
                // TODO Auto-generated method stub
              // Toast.makeText(getApplication(), DateFormat.format("yyyy:MM:dd", date), 1000).show();
            }
        });
    ...
    private void initButtonListeners(final Calendar nextYear, final Calendar lastYear) {
        ...
        decorator.setOnClickListener(new OnClickListener() {
            @Override public void onClick(View v) {
                ...
                calendar.setDecorators(Arrays.<CalendarCellDecorator>asList(new CalendarDecorator()));
                calendar.init(lastYear.getTime(), nextYear.getTime()) //
                        .inMode(SelectionMode.SINGLE) //
                        .withSelectedDate(new Date());
            }
